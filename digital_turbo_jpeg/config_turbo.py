...
MS_SYMBOL = 2     # 1シンボル＝1.0ミリ秒の超高速 (2000 bps)
...
BIT_TILE_X = 8          # タイルX座標
BIT_TILE_Y = 8          # タイルY座標
BIT_PAYLOAD_LENGTH = 16 # JPEGデータ長 (最大65,535バイト)
...
# --- ファイル・パス設定 (新階層 1対1 対応) ---
TEXT_LOG_DIR = "data/digital_turbo_jpeg/logs"
TEXT_LOG_PREFIX = "turbo_bitstream"
IMAGE_OUT_DIR = "data/digital_turbo_jpeg/images"
IMAGE_OUT_NAME = "decoded_result_turbo.jpg"
